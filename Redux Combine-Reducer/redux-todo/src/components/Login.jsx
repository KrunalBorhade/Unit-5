    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit} action="" style={{
                ...
                <input onChange={handleChange} id="email" type="email" placeholder="Enter Your E-mail"/>

                <input onChange={handleChange} id="password" type="text" placeholder="Enter Your Password"/>
